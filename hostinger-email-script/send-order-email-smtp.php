<?php
// Hostinger Email Script for Boult India Orders (SMTP Version)
// Upload this file to: public_html/send-order-email.php
...
foreach ($items as $item) {
    ...
    $itemsHTML .= "<tr>
        <td style='padding: 10px; border-bottom: 1px solid #eee;'>
            ...
            <small>Variant: {$itemVariant}</small>
        </td>
                ...
                <tr>
                    <td style="background-color: #f9f9f9; padding: 20px; text-align: center;">
                        <p style="margin: 0; color: #999; font-size: 12px;">
                            © 2024 Boult India. All rights reserved.
                        </p>
                    </td>
                </tr>
            </table>
...
$smtp_port = 587;
$smtp_username = 'admin-orders@boultindia.com';
$smtp_password = 'YOUR_EMAIL_PASSWORD_HERE'; // ⚠️ CHANGE THIS!

// Email details
$to = $customerEmail;
$cc = 'vtechmultisolutions@gmail.com';
$subject = "Order Confirmation - {$orderId} | Boult India";
$from = "Boult India Orders <admin-orders@boultindia.com>";

// Create email headers
$headers = "From: {$from}\r\n";
$headers .= "Reply-To: admin-orders@boultindia.com\r\n";
$headers .= "Cc: {$cc}\r\n";
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=UTF-8\r\n";

// Try using mail() function first (works on some Hostinger setups)
...
if ($sent) {
    ...
    // If mail() fails, return error with instructions
    http_response_code(500);
    echo json_encode([
        'success' => false,
        'error' => 'Failed to send email. Please configure SMTP settings in Hostinger cPanel.',
        'debug' => [
            'to' => $to,
            'cc' => $cc,
            'orderId' => $orderId
