...
$smtp_port = 587;
$smtp_user = 'vtechmultisolutions@gmail.com';
$smtp_pass = 'YOUR_GMAIL_APP_PASSWORD_HERE'; // ⚠️ Need to generate this!

// Email details
$to = $customerEmail;
$subject = "Order Confirmation - {$orderId} | Boult India";
$from = "Boult India <vtechmultisolutions@gmail.com>";
...
if ($sent) {
    ...
    // If mail() fails, return detailed error
    http_response_code(500);
    echo json_encode([
        'success' => false,
        'error' => 'Email sending failed. Hostinger mail() function not working.',
        'solution' => 'Please enable SMTP in Hostinger cPanel or use external email service',
        'debug' => [
            'orderId' => $orderId,
            'to' => $to,
            'smtp_required' => true
